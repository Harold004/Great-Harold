...
<tr><th>Nom</th><th>Prénom</th><th>Login</th><th>Gère le(s) stock(s)</th><th>Admin (Oui ou Non)</th><th>Modifier</th><th>Supprimer</th><th>Agence</th></tr>
<?php
	...
	foreach ($tUtilisateurs as $util) {
		...
		echo "<tr><td>$util->nom</td><td>$util->prenom</td><td>$util->login</td><td>$nomsStock</td><td>$util->administrateur</td><td><a href=\"modifierUtilisateur.php?login=$util->login\">Modifier</a></td><td><a href=\"javascript:supprimer('$util->idUtilisateur');\">Supprimer</a></td><td>$util->agence</td></tr>";
	}
?>
</table>
<br><br><br><br>
