...
<form method="POST" name="formulaire" onsubmit="return validerForm();" action="ajoutersSortie_trt.php">
...
&nbsp;&nbsp;&nbsp
<button type="button" class="boutonAnnuler" onclick="javascript:window.location='receptionniste.php'">Annuler</button>
</form>
