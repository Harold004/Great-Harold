<?php
    ...
    $tUtilisateur = utilisateur::chargerTout();
?>
...
<br>
<h1>Ajout d'une expedition</h1>
<br>

<form method="POST" name="formulaire" onsubmit="return validerForm();" action="ajouterExpedition_trt.php">
...
<tr>
    ...
    <select name="utilisateur" id="utilisateur">
            <?php foreach ($tUtilisateur as $utilisateur) {
